...
export default function RegisterStudentPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.log('Student created successfully:', response.data); // Debug log
            ...
            if (err.response) {
                ...
                const errorMessage = err.response.data?.message || err.response.data?.error || 'Erreur du serveur';
