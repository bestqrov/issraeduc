            ...
            <div style={{ fontSize: '11px', marginBottom: '15px' }}>
                ...
                {credit > 0 && (
                    <div style={{
                        ...
                        <span style={{ marginRight: '10px' }}>Crédit:</span>
                        <span style={{ fontWeight: 'bold', color: 'green' }}>-{credit.toFixed(2)} MAD</span>
                    </div>
                )}
                <div style={{
                    display: 'flex',
                    ...
                    <span style={{ fontWeight: 'bold' }}>{(total - credit).toFixed(2)} MAD</span>
                </div>
                <div style={{
                    display: 'flex',
                    justifyContent: 'flex-end'
