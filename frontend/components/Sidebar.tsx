  ...
  return (
    <>
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-3 rounded-xl bg-[#22284a] text-white shadow-lg border border-[#334155]"
      ...
      `}
        style={{
          background: 'radial-gradient(circle at 0% 0%, #2e3561 0%, #22284a 100%)'
        }}
      >
        <div className="p-6">
