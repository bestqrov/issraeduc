...
import { Sun, Moon, Cloud, Bell, Search, Menu, Timer, Sparkles, Users } from 'lucide-react';
...
export default function TopBar() {
    ...
    return (
        <header className="h-16 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-700 fixed top-0 right-0 left-72 z-20 pl-12 pr-6 flex items-center justify-between transition-all duration-300">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="hidden sm:flex items-center gap-2">
                    <button
                        ...
                        className="flex items-center gap-2 px-3 py-1.5 bg-white/50 hover:bg-white/60 text-sm rounded-full border border-white/10 text-slate-700 dark:text-slate-200"
                    >
                        <Users size={16} />
                        <span>Parents</span>
                    </button>
                    <button
                        ...
                        className="flex items-center gap-2 px-3 py-1.5 bg-white/5 hover:bg-white/10 text-sm rounded-full border border-white/5 text-slate-300"
                    >
                        <Users size={16} />
                        <span>Élèves</span>
                    </button>
