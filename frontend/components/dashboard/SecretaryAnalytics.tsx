        ...
        <div className="space-y-8">
            ...
            <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    <Link href="/secretary/students" className="block">
                        <div className="bg-white rounded-xl shadow-sm p-4 border border-slate-100 hover:shadow-md transition-all">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-sm font-medium text-gray-600">Gestion des Élèves</p>
                                    <p className="text-xl font-bold text-gray-900">Accéder</p>
                                </div>
