...
async function main() {
    ...
    const admin = await prisma.user.upsert({
        where: { email: 'admin@enova.com' },
        update: {},
        create: {
            email: 'admin@enova.com',
            password: hashedAdminPassword,
            name: 'Administrateur ENOVA',
            role: 'ADMIN',
        },
    });
    ...
    const secretary = await prisma.user.upsert({
        where: { email: 'secretary@enova.com' },
        update: {
            name: 'Souad Enova',
        },
        create: {
            email: 'secretary@enova.com',
    ...
    console.log('\n📋 Login Credentials:');
    console.log('\n🔐 ADMIN:');
    console.log('Email: admin@enova.com');
    console.log('Password: admin123');
    console.log('\n🔐 SECRETARY:');
    console.log('Email: secretary@enova.com');
